...
-- Utilizar LEFT JOIN para obtener todos los datos de la tabla izquierda y los datos coincidentes de la tabla derecha

SELECT c.CustomerId, c.FirstName, c.LastName, i.InvoiceId, i.InvoiceDate, i.Total
FROM Customer c
LEFT JOIN Invoice i ON c.CustomerId = i.CustomerId

-- Utilizar RIGHT JOIN para obtener todos los datos de la tabla derecha y los datos coincidentes de la tabla izquierda
...
-- Utilizar FULL OUTER JOIN para obtener todos los datos de ambas tablas

SELECT c.CustomerId, c.FirstName, c.LastName, i.InvoiceId, i.InvoiceDate, i.Total
FROM Customer c
FULL OUTER JOIN Invoice i ON c.CustomerId = i.CustomerId

/* Utilizar INNER JOIN para obtener sólo los datos coincidentes de ambas tablas */
